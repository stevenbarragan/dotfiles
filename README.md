...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/stevenbarragan/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/stevenbarragan/dotfiles/develop/install.sh`" -s ask
```
